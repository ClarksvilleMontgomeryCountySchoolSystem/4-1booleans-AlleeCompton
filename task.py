...
#The easiest variables to understand were the ones that begin with positive things like is or are.
# Positive statements are easier to understand, because of the way they are asked.
# Generally it is easier to answer a yes or no question, rather than a question with a double negative statement.
# Which were most confusing? Why?
#The questions that began with the word not. They were harder to answer because of the double negative statement.
#You have to think backwards to make the statements accurate.
